...
int main()
{
    ...
    cout << ", index= " << hex << ", buf=" << write_buffer[BUF_SIZE -1] << endl;
    cout << ", index= " << hex << ", buf=" << write_buffer[BUF_SIZE -2] << endl;
    ...
    // }
    cout << ", index= " << hex << ", buf=" << read_buffer[BUF_SIZE -1] << endl;
    cout << ", index= " << hex << ", buf=" << read_buffer[BUF_SIZE -2] << endl;
